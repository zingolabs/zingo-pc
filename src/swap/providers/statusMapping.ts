...
export function mapSwapStatus(raw: string | undefined): SwapStatusEnum | undefined {
...
export function mapTrackingStatus(raw: string | undefined): TrackingStatusEnum | undefined {
  if (!raw) return undefined;
